        ...
        <div className="bg-primary">
            <div className="px-5 md:w-5/6 text-center mx-auto py-8 grid grid-cols-2 gap-x-10">
                ...
                <div className="col-span-2 md:col-span-1 flex items-center justify-center md:justify-start mt-5 md:mt-0">
                    <a href="./contato" className=" cursor-pointer py-3 px-10 font-medium text-md border-2 border-white hover:bg-white text-white hover:text-primary  rounded-xl uppercase transition duration-300 ease-in-out">simulador online</a>
                </div>
            </div>
        </div>
    )
